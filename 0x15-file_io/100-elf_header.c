...
void print_magig(unsigned char *e_ident)
{
	int index;
...
/**
 * print_version - prints the verssion of an ELF header
 * @e_ident: ponter to an array containing of ELF version
 *
 */
...
/**
 * close-elf - closes an ELF file
 * @elf: the filedescriptor of the ELF
 *
 */
